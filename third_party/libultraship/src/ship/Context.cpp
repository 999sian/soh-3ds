...
bool Context::InitLogging(spdlog::level::level_enum debugBuildLogLevel,
    ...
    try {
        // Setup Logging
#ifndef __3DS__
        // The 3DS logger below is synchronous and never consumes this queue.
