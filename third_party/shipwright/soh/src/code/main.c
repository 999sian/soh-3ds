...
#ifdef __3DS__
    {
        extern bool Soh3dsEnsureGameData(void);
        if (!Soh3dsEnsureGameData()) {
            SOH3DS_TRACE("native setup did not produce usable game data");
            return 1;
        }
    }
#endif
