...
#ifdef __3DS__
    if (Soh3dsRandoMenu_IsOpen()) {
        Soh3dsRandoMenu_Update(CHECK_BTN_ALL(input->press.button, BTN_A),
                               CHECK_BTN_ALL(input->press.button, BTN_B),
                               this->stickRelY > 30 || (dpad && CHECK_BTN_ALL(input->press.button, BTN_DUP)),
                               this->stickRelY < -30 || (dpad && CHECK_BTN_ALL(input->press.button, BTN_DDOWN)),
                               this->stickRelX < -30 || (dpad && CHECK_BTN_ALL(input->press.button, BTN_DLEFT)),
                               this->stickRelX > 30 || (dpad && CHECK_BTN_ALL(input->press.button, BTN_DRIGHT)));
        return;
    }
#endif
...
#ifdef __3DS__
    Soh3dsRandoMenu_Draw(&this->state);
#endif
