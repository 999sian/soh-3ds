...
u32 osGetCount(void); // SoH-3DS: u32, matching libultraship/libultra/os.h
...
uint8_t Randomizer_GenerateFromSeed(const char* seed);
uint8_t Randomizer_ImportSpoilerFile(const char* fileLoc);
uint8_t Randomizer_ApplyPreset3DS(uint8_t presetIndex);
